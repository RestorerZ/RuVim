...
"
" Maintainer:	 Restorer <restorers@users.sourceforge.org>
" Last Changed:	 26 Aug 2021
" Version:	 2.0
" Description:	 описание находится в конце файла

" Расположение символов для русского языка при подключенном файле с раскладкой
" клавиатуры «русская типографская» (russian-typograph.vim). Версия 2.0
...
"	The CTRL and SHIFT keys pressed
<C-S-char-0x0020>   <char-0x00A0>	" NO-BREAK SPACE
